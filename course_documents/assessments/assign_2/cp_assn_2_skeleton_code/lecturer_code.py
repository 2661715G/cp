...
# print(skeleton_runs())
# start, graph = generate_binary_tree_instance(1)
start, graph = generate_ladder_instance()
print(submitted_solution.run_cp(graph, start, timeout=5000)["num_saved"])